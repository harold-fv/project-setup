...
fetch(`https://api.nutritionix.com/v1_1/search?q=${query}&appId=${appId}&appKey=${apiKey}`)
...
fetch('https://api.edamam.com/api/food-database/v2/parser?app_id=' + appeda_Id + '&app_key=' + appedaKey + '&ingr=asparagus', {
  ...
  // let mealNCalories = data.calories;
  // let meal[n]FatCalories = data.calories.FAT_KCAL;
  // let meal[n]CarbCalories = data.calories.CHOCDF_KCAL;
  // let meal[n]ProteinCalories = data.calories.CPROCNT_KCAL;
